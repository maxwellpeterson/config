...
before packages are loaded."
  ...
  ;; See https://github.com/golang/tools/blob/master/gopls/doc/emacs.md#configuring-gopls-via-lsp-mode
  ;; (lsp-register-custom-settings '(("gopls.annotations" '((bounds . t)) t)))
